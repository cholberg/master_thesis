...
def sliced_wasserstein_distance(
    first_samples, second_samples, num_projections=1000, p=2, device="cuda"
):
...
def max_sliced_wasserstein_distance(
    first_samples, second_samples, p=2, max_iter=100, device="cuda"
):
    ...
    for _ in range(max_iter):
        ...
        wasserstein_distance = (
            torch.abs(
                (
                    torch.sort(encoded_projections)[0]
